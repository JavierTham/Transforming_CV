...
NUM_CLASSES = 100
STATE_DICT_PATH = "states/MobileNetv2_LSTM_epoch10.pth"
...
torch.save(output[0], "../output/MobileNetv2_LSTM/pictures.pt")
torch.save(output[1], "../output/MobileNetv2_LSTM/all_y_true.pt")
torch.save(output[2], "../output/MobileNetv2_LSTM/all_y_pred.pt")
torch.save(output[3], "../output/MobileNetv2_LSTM/y_true_examples.pt")
torch.save(output[4], "../output/MobileNetv2_LSTM/y_pred_examples.pt")